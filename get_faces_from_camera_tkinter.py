...
class Face_Register:
    ...
    def GUI_info(self):
        ...
        tk.Label(self.frame_right_info,
                 ...
                 text="Clear face photos").grid(row=5, column=0, columnspan=2, sticky=tk.W, padx=5, pady=20)
        ...
        tk.Label(self.frame_right_info,
                 font=self.font_step_title,
                 text="Input student ID").grid(row=7, column=0, columnspan=2, sticky=tk.W, padx=5, pady=20)
